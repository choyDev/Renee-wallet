...
//   const TotalUsd = Number(solanaWallet?.balances?.[0]?.usd ?? "0") + Number(solUSDT ?? "0");
...
//           <div className="group relative h-full rounded-2xl p-px bg-gradient-to-br from-brand-400/40 via-transparent to-[#14F195]/30">
...
//                   <CryptoPriceChart initialAsset="SOL" hideAssetTabs />
//                 </div>
//               </div>
//             </div>
//           </div>
...
//                       <SiSolana className="w-7 h-7 text-[#14F195]" />
//                     </div>
//                     <div>
...
//                       SOL {solanaWallet?.balances?.[0]?.amount ?? "0"}
//                     </div>
//                     <div className="text-sm text-gray-500 dark:text-gray-400 tabular-nums">
//                       {usd(solanaWallet?.balances?.[0]?.usd ?? 0)}
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//                         USDT
//                       </div>
//                       <div className="text-sm text-gray-500 dark:text-gray-400">USDT (SPL)</div>
//                     </div>
//                   </div>
    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-4 sm:p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6 space-y-4 sm:space-y-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-4 items-stretch">
        ...
        <section className="col-span-1 lg:col-span-8">
          <div className="group relative h-full rounded-2xl p-px bg-gradient-to-br from-[#14F195]/40 via-transparent to-[#00FFA3]/30">
            <div className="h-full rounded-2xl border border-gray-200/60 dark:border-white/10 
        ...
        <aside className="col-span-1 lg:col-span-4">
          <div className="flex h-full flex-col gap-3 sm:gap-4">
            ...
            {/* Total Balance */}
            <div className="rounded-2xl p-px bg-gradient-to-r from-[#14F195]/50 to-cyan-500/40">
              <div className="rounded-2xl border border-gray-200/60 dark:border-white/10 
                            bg-white/70 dark:bg-[#110f20] dark:bg-[radial-gradient(circle_at_30%_20%,#120a22_0%,#131124_70%)] backdrop-blur-sm 
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                    <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl bg-gray-100 dark:bg-white/10
                      ...
                      <SiSolana className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-[#14F195]" />
                    </div>
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">SOL</div>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">USDT (SPL)</div>
                    </div>
                  </div>
            ...
            <div className="mt-auto">
              <WalletBalanceCard
                ...
                walletsBySymbol={{
                  SOL: solanaWallet
                    ? { id: solanaWallet.id, address: solanaWallet.address }
                    : undefined,
                }}
              />
            </div>
