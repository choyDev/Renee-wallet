...
//   const TotalUsd = Number(xrpWallet?.balances?.[0]?.usd ?? "0");
...
//           <div className="group relative h-full rounded-2xl p-px bg-gradient-to-br from-brand-400/40 via-transparent to-[#25A768]/30">
...
//                   <CryptoPriceChart initialAsset="XRP" hideAssetTabs />
//                 </div>
//               </div>
//             </div>
//           </div>
...
//                        <SiXrp className="w-7 h-7 text-[#25A768]" />
//                     </div>
//                     <div>
    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-4 sm:p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6 space-y-4 sm:space-y-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-4 items-stretch">
        ...
        <section className="col-span-1 lg:col-span-8">
          <div className="group relative h-full rounded-2xl p-px bg-gradient-to-br from-[#25A768]/40 via-transparent to-[#1bcf7e]/30">
            <div className="h-full rounded-2xl border border-gray-200/60 dark:border-white/10 
                            bg-white/70 dark:bg-[#110f20] bg-[radial-gradient(circle_at_30%_20%,#120a22_0%,#131124_70%)] backdrop-blur-sm 
                            shadow-[0_1px_0_0_rgba(255,255,255,0.06)_inset,0_10px_30px_-10px_rgba(0,0,0,0.35)]
                            transition-all duration-300 group-hover:shadow-lg">
        ...
        <aside className="col-span-1 lg:col-span-4">
          <div className="flex h-full flex-col gap-3 sm:gap-4">
            ...
            {/* TOTAL BALANCE */}
            <div className="rounded-2xl p-px bg-gradient-to-r from-[#25A768]/50 to-cyan-500/40">
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                    <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl bg-gray-100 dark:bg-white/10
                      ...
                      <SiXrp className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-[#25A768]" />
                    </div>
            ...
            <div className="mt-auto">
              <WalletBalanceCard
                ...
                walletsBySymbol={{
                  XRP: xrpWallet
                    ? { id: xrpWallet.id, address: xrpWallet.address }
                    : undefined,
                }}
              />
            </div>
