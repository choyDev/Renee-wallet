...
//           <div className="group relative h-full rounded-2xl p-px bg-gradient-to-br from-brand-400/40 via-transparent to-[#C2A633]/30">
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                    <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl bg-gray-100 dark:bg-white/10 
                      ...
                      <SiDogecoin className="text-[#C2A633] w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7" />
                    </div>
                  ...
                  <div className="text-right flex-shrink-0">
                    <div className="text-sm sm:text-base md:text-lg font-semibold tabular-nums text-gray-900 dark:text-white">
                      {dogeWallet?.balances?.[0]?.amount ?? "0"}
                    </div>
