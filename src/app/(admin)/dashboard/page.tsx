...
//           change="+9.25%"
//           color="#10B981"
//           icon={<SiSolana className="text-purple-400 size-6" />}
...
//           change="+7.05%"
//           color="#3B82F6"
//           icon={<FaEthereum className="text-blue-400 size-6" />}
//           data={[12, 18, 14, 20, 24, 21, 26]}
//         />
//       </div>
...
// /* 💰 Balance Card */
// const BalanceCard = () => (
//   <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#121B2E] p-6 shadow-sm hover:shadow-md transition">
//     <div className="flex items-center gap-3">
//       <div className="flex justify-center items-center w-12 h-12 rounded-xl bg-gray-100 dark:bg-gray-800">
//         <SiTether className="text-brand-500 size-6" />
//       </div>
...
//         $125,821
//       </h3>
//       <p className="text-gray-500 dark:text-gray-400">$821.85</p>
//     </div>
//     <div className="flex justify-between items-center mt-3">
//       <span className="text-gray-400 text-sm">+102.15%</span>
//       <span className="px-2 py-0.5 rounded-full text-xs font-semibold bg-green-100 text-green-600 dark:bg-green-500/20">
//         +15.6%
//       </span>
//     </div>
//   </div>
...
//     <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-[#121B2E] p-6 shadow-sm hover:shadow-md transition">
//       <div className="flex items-center gap-3">
//         <div className="flex justify-center items-center w-12 h-12 bg-gray-100 dark:bg-gray-800 rounded-xl">
//           {icon}
//         </div>
//         <div>
//           <h4 className="font-semibold text-gray-800 dark:text-white/90">
...
//           {value}
//         </h3>
//         <p className="text-gray-500 text-sm dark:text-gray-400">{sub}</p>
//       </div>
...
// /* 💰 Balance Card */
// const BalanceCard = () => (
//   <div className="rounded-2xl bg-white dark:bg-[#111827] border border-gray-200 dark:border-gray-800 shadow-md hover:shadow-lg transition p-6">
//     <div className="flex items-center gap-3">
//       <div className="flex justify-center items-center w-12 h-12 rounded-xl bg-[#E5F3FF] dark:bg-[#1F2A44]">
...
//       <p className="text-gray-500 dark:text-gray-400 text-sm">$821.85</p>
//     </div>

//     <div className="flex justify-between items-center mt-4">
//       <span className="text-gray-500 dark:text-gray-400 text-sm">+102.15%</span>
//       <span className="px-2 py-0.5 rounded-full text-xs font-semibold bg-[#E5F9F2] text-[#10B981] dark:bg-[#10B981]/20 dark:text-[#10B981]">
//         +15.6%
//       </span>
//     </div>
//   </div>
...
//     <div className="rounded-2xl bg-white dark:bg-[#111827] border border-gray-200 dark:border-gray-800 shadow-md hover:shadow-lg transition p-6">
//       <div className="flex items-center gap-3">
//         <div className="flex justify-center items-center w-12 h-12 rounded-xl bg-gray-100 dark:bg-[#1F2A44]">
//           {icon}
//         </div>
//         <div>
//           <h4 className="font-semibold text-gray-700 dark:text-white/90 text-[15px]">
...
//             positive
//               ? "bg-[#E5F9F2] text-[#10B981] dark:bg-[#10B981]/20 dark:text-[#10B981]"
//               : "bg-[#FDECEC] text-[#EF4444] dark:bg-[#EF4444]/20 dark:text-[#F87171]"
//           }`}
//         >
//           {change}
//         </span>
...
// /* 💰 Balance Card */
// const BalanceCard = () => (
//   <div className="rounded-2xl bg-white dark:bg-[#111827] border border-gray-200 dark:border-gray-800 shadow-md hover:shadow-lg transition p-6 flex flex-col justify-between">
//     <div className="flex items-center gap-3">
//       <div className="flex justify-center items-center w-12 h-12 rounded-xl bg-[#E5F3FF] dark:bg-[#1F2A44]">
//         <SiTether className="text-[#0057FF] dark:text-[#5CA9FF] size-6" />
//       </div>
...
//         $125,821
//       </h3>
//       <p className="text-[15px] text-gray-500 dark:text-gray-400 mt-1">$821.85</p>
//     </div>
...
//           {value}
//         </h3>
//         <p className="text-[15px] text-gray-500 dark:text-gray-400 mt-1">{sub}</p>
//       </div>
