...
//                       dark:from-[#1B2435] dark:via-[#121B2E] dark:to-[#0E1624]
//                       text-gray-800 dark:text-white border border-gray-200 dark:border-gray-700 shadow-lg transition-colors duration-300"
//         >
//           {/* Soft overlay for shine */}
