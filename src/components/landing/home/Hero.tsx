        ...
        <>
            ...
            >
                        ...
                        <div className="w-full px-4">
                            <div className="mx-auto max-w-[800px] text-center">
                                <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                                    A custodial hot wallet for <span className="text-primary dark:text-primary">TRY → USDT</span> with KYC and on-ramp.
                                </h1>
                                <p className="mb-12 text-base !leading-relaxed text-body-color dark:text-body-color-dark sm:text-lg md:text-xl">
                                    Deposit Turkish Lira → automatically convert to USDT → credit your on-chain wallets on <strong>TRON (TRC-20)</strong> and <strong>Solana (SPL)</strong>. Withdrawals are disabled.
                                </p>
                ...
                <div className="absolute bottom-0 left-0 z-[-1] opacity-30 lg:opacity-100">
                    <svg
                        className="w-[180px] sm:w-[260px] lg:w-[364px] h-auto"
                        viewBox="0 0 364 201"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
