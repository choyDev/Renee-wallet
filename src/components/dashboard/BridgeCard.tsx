...
//       <div className="h-full rounded-3xl bg-[#101422]/80 backdrop-blur-xl border border-white/10 shadow-[0_0_40px_-10px_rgba(0,0,0,0.5)] p-7 flex flex-col">
        
//         {/* Header */}
//         <div className="flex items-center justify-between mb-6">
//           <h3 className="text-xl font-bold text-white tracking-tight">Bridge</h3>
...
//           {/* ----- FROM BOX ------ */}
//           <div className="glass-box p-4 rounded-2xl border border-white/10 bg-white/5 shadow-inner">
...
//                 placeholder="0.0"
//                 className="bg-transparent w-full text-2xl font-semibold text-white outline-none placeholder:text-gray-600"
//               />

//               {/* Chain Selector */}
//               <div
//                 style={{ borderColor: getChain(fromChain)?.color + "50" }}
//                 className="px-4 py-2 ml-3 rounded-xl bg-white/10 backdrop-blur-sm border flex items-center gap-2 cursor-pointer hover:bg-white/15 transition"
//               >
//                 <span style={{ color: getChain(fromChain)?.color }}>
//                   {getChain(fromChain)?.icon}
//                 </span>
//                 <span className="text-sm font-semibold text-white">{fromChain}</span>
//               </div>
//             </div>
...
//               onClick={swap}
//               className="
//                 w-12 h-12 rounded-full bg-purple-500/20 border border-purple-500/40 
//                 flex items-center justify-center text-purple-300 hover:bg-purple-500/30 
...
//                 </span>
//                 <span className="text-sm font-semibold text-white">{toChain}</span>
//               </div>
//             </div>
...
//           {/* Fees */}
//           <div className="rounded-2xl p-4 bg-gradient-to-r from-purple-500/10 to-indigo-500/10 border border-purple-500/20">
...
//             className="
//               w-full py-3 rounded-2xl bg-gradient-to-r 
//               from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 
//               disabled:opacity-50 disabled:cursor-not-allowed
//               text-white font-semibold text-sm transition-all duration-300 shadow-lg
//             "
//           >
//             Bridge Assets
//           </button>
